...
import vo2maxLogo from "./assets/vo2max-logo-new.png";
  ...
  return (
    <div className="min-h-screen bg-vo-white text-vo-black" id="home">
      <header className="sticky top-0 z-50 border-b border-vo-border/60 bg-vo-white/95 backdrop-blur">
        <div className={`${containerClass} grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 py-2.5 sm:grid-cols-[auto_minmax(0,0.55fr)_auto] sm:gap-4 sm:py-3.5 lg:grid-cols-[auto_minmax(0,0.5fr)_auto] lg:gap-6`}>
          <a
            href="#home"
      ...
      <main>
        ...
        <section className={`${containerClass} grid gap-10 pb-14 pt-6 md:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] md:items-center md:gap-16`}>
          ...
          <div className="relative">
            <div className="absolute -top-10 left-10 h-40 w-40 rounded-full bg-vo-blue-soft blur-3xl opacity-70" aria-hidden />
      ...
      <section id="contact" className="bg-vo-white py-14 sm:py-18">
        <div className={`${containerClass} grid gap-6 rounded-4xl border border-vo-border/80 bg-gradient-to-br from-vo-white via-vo-white to-vo-blue-soft/20 p-8 shadow-card shadow-vo-blue/10 sm:grid-cols-[minmax(0,0.9fr)_minmax(0,0.9fr)]`}>
    ...
    <footer className="bg-vo-black text-vo-white">
      <div className={`${containerClass} flex flex-col gap-8 py-12 lg:flex-row lg:items-center lg:justify-between`}>
        <div className="space-y-4">
            <a
