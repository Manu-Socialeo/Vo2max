    ...
    <footer className="border-t border-gray-100 bg-white">
      <div className="mx-auto max-w-[1240px] px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold text-[#343434]">Quick Links</h3>
            <ul className="space-y-3 text-sm text-[#343434]/70">
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold text-[#343434]">Our Services</h3>
            <ul className="space-y-3 text-sm text-[#343434]/70">
              <li><Link href="/services/physiotherapy" className="transition-colors hover:text-[#0052FF]">Physiotherapy</Link></li>
              <li><Link href="/services/rehabilitation" className="transition-colors hover:text-[#0052FF]">Rehabilitation</Link></li>
              <li><Link href="/services/sports-rehabilitation" className="transition-colors hover:text-[#0052FF]">Sports Rehab</Link></li>
              <li><Link href="/services/cardiac-rehabilitation" className="transition-colors hover:text-[#0052FF]">Cardiac Rehabilitation</Link></li>
              <li><Link href="/services/exercise-therapy" className="transition-colors hover:text-[#0052FF]">Exercise Therapy</Link></li>
              <li><Link href="/services/weight-loss" className="transition-colors hover:text-[#0052FF]">Weight Loss</Link></li>
              <li><Link href="/services/fat-loss" className="transition-colors hover:text-[#0052FF]">Fat Loss</Link></li>
              <li><Link href="/services/athletic-training" className="transition-colors hover:text-[#0052FF]">Athletic Training</Link></li>
              <li><Link href="/services/functional-training" className="transition-colors hover:text-[#0052FF]">Functional Training</Link></li>
              <li><Link href="/services/posture-correction" className="transition-colors hover:text-[#0052FF]">Posture Correction</Link></li>
              <li><Link href="/services/neurology-rehabilitation" className="transition-colors hover:text-[#0052FF]">Neuro Rehabilitation</Link></li>
              <li><Link href="/services/post-surgical-rehabilitation" className="transition-colors hover:text-[#0052FF]">Post-Surgery Rehab</Link></li>
              <li><Link href="/services/child-obesity-support" className="transition-colors hover:text-[#0052FF]">Child Obesity Support</Link></li>
              <li><Link href="/services/electrotherapy" className="transition-colors hover:text-[#0052FF]">Electrotherapy</Link></li>
              <li><Link href="/services" className="text-xs font-medium text-[#0052FF] transition-colors hover:text-[#0046E0]">View All Services <ArrowRight className="inline h-3 w-3 ml-1" /></Link></li>
            </ul>
          </div>

          <div>
            <h3 className="mb-4 text-sm font-semibold text-[#343434]">Contact</h3>
            <ul className="space-y-3 text-sm text-[#343434]/70">
              ...
              <li>
                <a href={`mailto:${clinic.email}`} className="flex items-center gap-2 transition-colors hover:text-[#0052FF]">
                  ...
                  <span className="text-xs">{clinic.email}</span>
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="mt-10 border-t border-gray-100 pt-6">
          <div className="flex flex-col items-center justify-between gap-4 text-center text-xs text-[#343434]/50 sm:flex-row sm:text-left">
